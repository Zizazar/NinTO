...
{
    public class LeavingCoffeeNpcNpcState : INpcState
    {
        ...
        public void Enter(NpcStateMachine stateMachine)
        {
            ...
            _controller.transform.position = _controller.pathPositions.Last();
            _moveTweener = _controller.transform.DOPath(_controller.pathPositions.Reverse().ToArray(), _controller.movementSpeed, PathType.CatmullRom, gizmoColor: Color.red)
                .SetSpeedBased(true)
                .SetEase(Ease.Linear)
